...
public class MainActivity extends Activity {
    ...
    tv.setText("Hello! This is ProtectedWorkProfile app.\n" +
			...
			"This profile is designed to protect any data in everyday life.\nEven if you are an ordinary user — this app is for you.\nBut be careful: do not connect your phone to USB (PC, mouse, etc.\n) and do not press the Destroy🔥 button if you do not want to delete data.\nThe Destroy🔥 button is needed to quickly delete data in an emergency situation, for example, when you are being forced to show your phone.\nYou can also enable extreme protection for such cases in AdditionalOptions.\nData wiping upon USB connection is needed for protection against exploits.\n\n");
